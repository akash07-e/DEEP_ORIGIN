  ...
  return (
    <section id="slideshow" className="slideshow-section" aria-label="Image slideshow">
      ...
      <style>{`
        ...
        /* Slides are large cinematic height */
        .slides-area {
          position: relative;
          width: 100%;
          height: 80vh;   /* cinematic height (adjust if you want 100vh) */
          min-height: 420px;
          max-height: 1000px;
          background: #000;
        }
        ...
        .slide {
          position: absolute;
          inset: 0;
          width: 100vw;      /* ensure image covers full viewport width */
          height: 100%;
        ...
        @media (max-width: 900px) {
          .slides-area { height: 64vh; min-height: 320px; }
          .gallery-title { font-size: 2.1rem; }
          .arrow { font-size: 26px; padding: 10px 12px; left: 16px; right: 16px; }
          .caption-title { font-size: 1.15rem; }
        }
        @media (max-width: 480px) {
          .slides-area { height: 56vh; }
